...
* entry[+].fullUrl = "http://test.fhir.ch/r4/PractitionerRole/TC-practitionerrole1-author1"
* entry[=].resource = TC_practitionerrole1_author1
...
* author = Reference(TC_practitionerrole1_author1)
