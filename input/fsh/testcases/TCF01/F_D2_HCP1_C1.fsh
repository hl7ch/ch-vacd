...
* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/F-D2-HCP1-C1-Composition"
* entry[=].resource = F_D2_HCP1_C1_Composition
...
* entry[+].fullUrl = "http://test.fhir.ch/r4/Immunization/TCF01-IMMUN2"
* entry[=].resource = TCF01_IMMUN2
...
Instance: F_D2_HCP1_C1_Composition
...
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-US\" lang=\"en-US\"><p><b>Code: </b><span>Hx of Immunization (http://loinc.org#11369-6)</span></p><p><b>Entries:</b></p><table><tr><td><a href=\"Immunization-TCF01-IMMUN2.html\">Immunization/TCF01-IMMUN2</a></td></tr></table></div>"
* section[=].entry = Reference(TCF01_IMMUN2)
