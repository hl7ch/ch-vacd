...
* identifier.value = "urn:uuid:1fff153e-92d2-4f19-9d75-f114f2c35adb"
* type = #document
* timestamp = "2021-10-28T14:00:00.390+02:00"

* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/RDC03-Composition-b"
* entry[=].resource = RDC03_Composition_b
