...
* identifier.value = "urn:uuid:RDB03"
* type = #document
* timestamp = "2021-10-28T14:00:00.390+02:00"

* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/RDB03-Composition"
* entry[=].resource = RDB03_Composition
