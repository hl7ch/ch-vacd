...
* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/F-D5-HCP1-C1-Composition"
* entry[=].resource = F_D5_HCP1_C1_Composition
...
* entry[+].fullUrl = "http://test.fhir.ch/r4/Condition/TCF03-UNDILL1"
* entry[=].resource = TCF03_UNDILL1




Instance: F_D5_HCP1_C1_Composition
InstanceOf: CHVACDCompositionImmunizationAdministration
Title: "Administration Document Composition F_D5_HCP1_C1"
...
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-US\" lang=\"en-US\"><p><b>Code: </b><span>Hx of Past illness (http://loinc.org#11348-0)</span></p><p><b>Entries:</b></p><table><tr><td><a href=\"Condition-TCF03-UNDILL1.html\">Condition/TCF03-UNDILL1</a></td></tr></table></div>"
* section[=].entry = Reference(TCF03_UNDILL1)
