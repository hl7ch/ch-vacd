...
* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/F-D3-HCP1-C1-Composition"
* entry[=].resource = F_D3_HCP1_C1_Composition
...
* entry[+].fullUrl = "http://test.fhir.ch/r4/AllergyIntolerance/TCF02-ALLINTO1"
* entry[=].resource = TCF02_ALLINTO1
...
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"  lang=\"en-US\"><p><b>Code: </b><span>Allergies and adverse reactions Document (http://loinc.org#48765-2)</span></p><p><b>Entries:</b></p><table><tr><td><a href=\"AllergyIntolerance-TCF02-ALLINTO2.html\">AllergyIntolerance/TCF02-ALLINTO2</a></td></tr></table></div>"
* section[=].entry[+] = Reference(TCF02_ALLINTO1)
