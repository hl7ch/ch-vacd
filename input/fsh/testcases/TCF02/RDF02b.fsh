...
* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/RDF02-Composition-b"
* entry[=].resource = RDF02_Composition_b
...
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:uuid:3649c224-3bb5-43c8-acfe-817d9d565b38"
* status = #final
