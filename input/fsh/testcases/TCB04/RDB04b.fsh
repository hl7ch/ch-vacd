...
* identifier.value = "urn:uuid:703794d7-3afb-478f-bd9b-35dc4f530a9"
* type = #document
* timestamp = "2021-10-28T14:00:00.390+02:00"

* entry[+].fullUrl = "http://test.fhir.ch/r4/Composition/RDB04-Composition-b"
* entry[=].resource = RDB04_Composition_b
...
* section[=].text.status = #generated
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en-US\" lang=\"en-US\"><p><b>Code: </b><span>Serology studies (set) (http://loinc.org#18727-8)</span></p><p><b>Entries:</b></p><table><tr><td><a href=\"Observation-TCB04-LABRES1.html\">Observation/TCB04-LABRES1</a></td></tr></table></div>"
