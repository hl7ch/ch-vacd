...
Title: "CH VACD Extension Immunization Recorder Reference"
Description: "Extension to add a reference to the recorder (author) of the immunization. This can be a PractitionerRole or a Patient.
