ValueSet: BasicImmunizationCode
...
* $ch-vacd-basic-immunization-cs#bi-dtpa "Received basic immunization against DTPa in childhood."
...
* $ch-vacd-basic-immunization-cs#bi-polio "Received basic immunization against poliomyelitis in childhood."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-fsme "Received basic immunization against tick-borne encephalitis."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-hib "Received basic immunization against Haemophilus influenzae type b."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-hpv "Received basic immunization against Human papillomavirus."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-variz "Received basic immunization against varicella."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-mmr "Received basic immunization against Measles, Mumps, Rubella."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-pneumo "Received basic immunization against Pneumococcal infectious disease." 
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-hepb "Received basic immunization against viral hepatitis type B"
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-hepa "Received basic immunization against viral hepatitis type A"
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-herpzos "Received basic immunization against herpes zoster"
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-mening "Received basic immunization against meningococcal infectious disease."
  * ^designation[0].language = #de-CH
...
* $ch-vacd-basic-immunization-cs#bi-rabi "Received basic immunization against rabies"
  * ^designation[0].language = #de-CH
