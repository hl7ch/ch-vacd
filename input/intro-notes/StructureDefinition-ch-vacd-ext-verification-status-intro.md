...
Extension to define the verificationStatus on resources not defining this field like [Immunization](StructureDefinition-ch-vacd-immunization.html) and [Labor And Serologie (Observation)](StructureDefinition-ch-vacd-laboratory-serology.html).
