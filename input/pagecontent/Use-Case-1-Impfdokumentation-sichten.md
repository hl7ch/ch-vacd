...
Eine Gesundheitsfachperson sichtet die Impfdaten (*Impfausweis* und *Impfdokumentation*) im EPD eines Patienten in ihrem Primärsystem bzw. im Portal der Gemeinschaft. Sie wählt dazu die entsprechenden Benutzeroberflächen im Primärsystem bzw. im Portal aus und sucht den Patienten. Anschliessend ruft sie aus dem EPD den *Impfausweis* bzw. die *Impfdokumentation* mit folgenden Informationen ab: verabreichten Impfungen, Kontraindikationen, durchgemachte Infektionskrankheiten, Unerwünschte Impferscheinungen, Labor- und Serologiebefunde, medizinische Risikofaktoren sowie den Status der Grundimmunisierungen. Die Gesundheitsfachperson sichtet die Impfdaten im Primärsystem bzw. im Portal der Gemeinschaft und berücksichtigt die Informationen bei Diagnosen und Therapien.
