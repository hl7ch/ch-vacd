...
* [Use Case 1 (FR): Impfdokumentation sichten](usecase_1_epd_fr.html)
* [Use Case 2 (DE): Impfung dokumentieren](usecase_2_epd_de.html)
* [Use Case 2 (FR): Impfung dokumentieren](usecase_2_epd_fr.html)
* [Use Case 3 (DE): Impfdossier verifizieren und aktualisieren](usecase_3_epd_de.html)
* [Use Case 3 (FR): Impfdossier verifizieren und aktualisieren](usecase_3_epd_fr.html)
* [Use Case 4 (DE): Impfcheck ausführen](usecase_4_epd_de.html)
* [Use Case 4 (FR): Impfcheck ausführen](usecase_4_epd_fr.html)
* [Use Case 5 (DE): Verifizierbares Zertifikat erstellen](usecase_5_epd_de.html)
* [Use Case 5 (FR): Verifizierbares Zertifikat erstellen](usecase_5_epd_fr.html)
