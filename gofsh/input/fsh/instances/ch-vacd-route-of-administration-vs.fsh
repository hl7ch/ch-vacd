Instance: ch-vacd-route-of-administration-vs
...
* identifier.value = "2.16.756.5.30.1.1.11.12"
...
* compose.include.concept[0].code = #20030000
* compose.include.concept[=].display = "Intradermal use"
* compose.include.concept[=].designation[0].language = #de-CH
* compose.include.concept[=].designation[=].value = "intradermale Anwendung"
* compose.include.concept[=].designation[+].language = #fr-CH
* compose.include.concept[=].designation[=].value = "Voie intradermique"
...
* compose.include.concept[=].display = "Intramuscular use"
* compose.include.concept[=].designation[0].language = #de-CH
* compose.include.concept[=].designation[=].value = "intramuskuläre Anwendung"
* compose.include.concept[=].designation[+].language = #fr-CH
* compose.include.concept[=].designation[=].value = "Voie intramusculaire"
* compose.include.concept[=].designation[+].language = #it-CH
...
* compose.include.concept[=].display = "Nasal use"
* compose.include.concept[=].designation[0].language = #de-CH
* compose.include.concept[=].designation[=].value = "nasale Anwendung"
* compose.include.concept[=].designation[+].language = #fr-CH
* compose.include.concept[=].designation[=].value = "Voie nasale"
* compose.include.concept[=].designation[+].language = #it-CH
...
* compose.include.concept[=].designation[+].language = #fr-CH
* compose.include.concept[=].designation[=].value = "Voie orale"
* compose.include.concept[=].designation[+].language = #it-CH
...
* compose.include.concept[=].display = "Subcutaneous use"
* compose.include.concept[=].designation[0].language = #de-CH
* compose.include.concept[=].designation[=].value = "subkutane Anwendung"
* compose.include.concept[=].designation[+].language = #fr-CH
* compose.include.concept[=].designation[=].value = "Voie sous-cutanée"
* compose.include.concept[=].designation[+].language = #it-CH
